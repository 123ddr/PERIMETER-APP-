...
public class paralelogram extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paralelogram);

        Main2 = findViewById(R.id.myButtonParallelogram);

        Back2 = findViewById(R.id.myButtonParallelogramBack);
        ...
        Button myButtonSquare = findViewById(R.id.myButtonParallelogram);
